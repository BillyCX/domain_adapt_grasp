...
class MultiCategoryVAE(BinaryVAE):
    ...
    def get_discriminator_loss(self, src_conv, obj_conv, noobj_conv):         
        ...
        errD2_obj, dis_obj2 = self.get_loss_on_label(obj_conv, label_obj_tuned, self.net_encoder_target, self.net_discriminator_noobj, detach=True) 
    ...
    def update_generator(self, errG_obj, errG_src, errG_obj_2, errG_noobj_2, src_autoed_loss):
        ...
        autoed_loss = errG_src*0.005 + errG_obj*0.005 + errG_obj_2*0.005 + errG_noobj_2*0.005 + src_autoed_loss*1
